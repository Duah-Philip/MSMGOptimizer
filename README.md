...
[![CRAN
status](https://www.r-pkg.org/badges/version/MSMGOptimizer)](https://CRAN.R-project.org/package=MSMGOptimizer)
...
Inventory (LCI) data from Excel into a fully compatible CSV format for
...
Inspired by the original Python-based SimaPro CSV converter developed by
[Professor Massimo
Pizzol](https://github.com/massimopizzol/Simapro-CSV-converter).
